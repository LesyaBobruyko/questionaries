      ...
      <div className="scoreComments">
        ...
        {score >= 15 && score <= 19 && (
            <p>
              ...
              typically should have immediate initiation of pharmacotherapy
              and/or psychotherapy.
            </p>
        )}
        {score >= 20 && (
            <p>
              Scores 20 and greater suggest severe depression; patients
              typically should have immediate initiation of pharmacotherapy and
              expedited referral to mental health specialist.
            </p>
        )}
        {score > 4 && (
          <p>
